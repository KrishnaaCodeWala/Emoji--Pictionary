      ...
      {sorted.map((p) => {
        ...
        return (
          <motion.li
            ...
            key={p.id}
            className={`relative flex items-center gap-2 rounded-xl border-4 border-border shadow-[4px_4px_0_0_var(--color-border)] bg-surface px-3 py-2 mb-1 ${isLeft ? 'opacity-40 line-through' : ''}`}
          >
