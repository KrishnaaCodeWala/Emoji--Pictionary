...
export default function Game({
  ...
  if (room.mode === 'relay') {
    ...
    return (
      <ModeTransition mode="relay">
        <div className="gutter mx-auto flex w-full max-w-3xl flex-col gap-4 py-4 flex-1 min-h-0">
  ...
  return (
    <ModeTransition mode="classic">
      <div className="gutter mx-auto flex w-full max-w-3xl flex-col gap-4 py-4 flex-1 min-h-0 font-sans">
        <div className="flex items-center justify-between gap-3">
        ...
        {isDrawer ? (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-stretch flex-1 min-h-0">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-stretch flex-1 min-h-0">
            ...
            <div className="flex flex-col gap-3 min-h-0 flex-1">
              <Chat messages={messages} players={players} />
              <div className="z-10 -mx-4 bg-background/95 px-4 py-2 backdrop-blur md:static md:mx-0 md:bg-transparent md:px-0 md:py-0 md:backdrop-blur-none shrink-0">
